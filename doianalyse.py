...
st.dataframe(merged_df[['Date', 'Actual', 'Max Projected','% OOS Contribution','Projected % OOS Contribution']])
...
analisa_df['RL Qty Actual'] = analisa_df2['RL Qty Actual'].fillna(0)
analisa_df['RL Qty NEW after MIN QTY WH'] = analisa_df2['RL Qty NEW after MIN QTY WH'].fillna(0)
