...
bar_width = 0.4
ax.barh(y_indexes - bar_width/2, filtered_df['Landed DOI OLD'], width=bar_width, label='Landed DOI OLD', color='b', alpha=0.7)
ax.barh(y_indexes + bar_width/2, filtered_df['Landed DOI New'], width=bar_width, label='Landed DOI New', color='m', alpha=0.7)
ax.set_xlabel('Inbound_Date NEW')
