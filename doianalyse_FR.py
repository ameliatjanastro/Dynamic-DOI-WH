...
st.markdown("<h4 style='color: rgb(128, 128, 128);'>Overall View</h4>", unsafe_allow_html=True)
st.markdown(" ")
...
st.markdown("<h5 style='color: rgb(139, 69, 19);'>Landed DOI Comparison by L1 Category -  only for KOS</h5>", unsafe_allow_html=True)
